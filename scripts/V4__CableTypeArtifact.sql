...
--
-- Name: artifact; Type: TABLE; Schema: public; Owner: cabledb_dev
--
...
--
-- Name: artifact_pkey; Type: CONSTRAINT; Schema: public; Owner: cabledb_dev
--
...
ALTER TABLE artifact OWNER TO cabledb_dev;
